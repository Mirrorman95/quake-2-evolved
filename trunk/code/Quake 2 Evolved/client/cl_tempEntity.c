...
void CL_ParseTempEntity (){
	...
	case TE_GUNSHOT:		// Bullet hitting wall
		...
		i = rand() & 15;
		if (i >= 1 && i <= 3)
			S_PlaySound(pos, 0, 0, cl.media.sfxRichotecs[i - 1], 1.0f, ATTN_NORM, 0.0f);
	...
	case TE_SHIELD_SPARKS:
		...
		S_PlaySound(pos, 0, 0, cl.media.sfxLaserHit, 1.0f, ATTN_NORM, 0.0f);
	...
	case TE_SPLASH:
		...
		case SPLASH_SPARKS:
			...
			S_PlaySound(pos, 0, 0, cl.media.sfxSparks[rand() & 3], 1.0f, ATTN_STATIC, 0.0f);
			break;
	...
	case TE_RAILTRAIL:		// Railgun effect
		...
		S_PlaySound(pos2, 0, 0, cl.media.sfxRailgun, 1.0f, ATTN_NORM, 0.0f);
	...
	case TE_GRENADE_EXPLOSION_WATER:
		...
		if (type != TE_GRENADE_EXPLOSION_WATER){
			...
			S_PlaySound(pos, 0, 0, cl.media.sfxGrenadeExplosion, 1.0f, ATTN_NORM, 0.0f);
		}
		else {
			...
			R_ProjectDecalOntoWorld(pos, dir, rand() % 360, 40.0f, cl.time, cl.media.burnMarkMaterial);
			S_PlaySound(pos, 0, 0, cl.media.sfxWaterExplosion, 1.0f, ATTN_NORM, 0.0f);
		}
	...
	case TE_ROCKET_EXPLOSION_WATER:
		...
		if (type != TE_ROCKET_EXPLOSION_WATER){
			...
			CL_ExplosionParticles(pos);
			R_ProjectDecalOntoWorld(pos, dir, rand() % 360, 40.0f, cl.time, cl.media.burnMarkMaterial);
			S_PlaySound(pos, 0, 0, cl.media.sfxRocketExplosion, 1.0f, ATTN_NORM, 0.0f);
		}
		else {
			...
			R_ProjectDecalOntoWorld(pos, dir, rand() % 360, 40.0f, cl.time, cl.media.burnMarkMaterial);
			S_PlaySound(pos, 0, 0, cl.media.sfxWaterExplosion, 1, ATTN_NORM, 0);
		}
	...
	case TE_PLASMA_EXPLOSION:
		...
		if (type != TE_EXPLOSION1_BIG){
			...
			CL_ExplosionParticles(pos);
			R_ProjectDecalOntoWorld(pos, dir, rand() % 360, 40.0f, cl.time, cl.media.burnMarkMaterial);
			S_PlaySound(pos, 0, 0, cl.media.sfxRocketExplosion, 1, ATTN_NORM, 0);
		}
		else {
			// HACK!!!
	...
	case TE_LIGHTNING:
		...
		S_PlaySound(NULL, ent, CHAN_WEAPON, cl.media.sfxLightning, 1.0f, ATTN_NORM, 0.0f);
	...
	case TE_TRACKER_EXPLOSION:
		...
		S_PlaySound(pos, 0, 0, cl.media.sfxDisruptorExplosion, 1.0f, ATTN_NORM, 0.0f);
