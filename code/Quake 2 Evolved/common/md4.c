...
/*
 ...
 work. RSA Data Security, Inc. makes no representations concerning either the
...
//
// md4.c - Message-Digest Algorithm
//
...
/*
 ...
 ==================
*/
static void MD4_Encode (byte *output, UINT4 *input, uint length){
...
/*
 ...
 Assumes length is multiple of 4.
 ==================
*/
static void MD4_Decode (UINT4 *output, byte *input, uint length){
...
/*
 ...
 ==================
*/
static void MD4_Transform (UINT4 state[4], byte block[64]){
...
/*
 ...
 Continues an MD4 message-digest operation, processing another message block,
 and updating the context.
 ==================
*/
static void MD4_Update (MD4_CTX *context, byte *input, uint inputLen){
...
/*
 ...
 MD4 finalization.
 Ends an MD4 message-digest operation, writing the message digest and zeroizng
 the context.
 ==================
*/
...
ulong MD4_BlockChecksum (const void *data, int length){
	...
	MD4_Init(&ctx);
	MD4_Update(&ctx, (byte *)data, length);
